import { likes } from '../controllers/news.controller.js'
...
export const likeService = (idNews, userId) => News.findOneAndUpdate(
    { _id: idNews, "likes.userId": { $nin: [userId] } }, { $push: { likes: { userId, created: new Date() } } }
)

export const deleteLikeService = (idNews, userId) => News.findOneAndUpdate(
